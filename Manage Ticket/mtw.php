...
$conn = new mysqli($servername, $username,$password,$database);
$sql = "SELECT  Ticket_ID, ticket.Residence_ID, textDescription, Residence_Name, ticket.Warden_ID, Status_Update
FROM ticket, residence
Where ticket.Residence_ID = residence.Residence_ID and ticket.Warden_ID = '$ID' ";
$result= mysqli_query($conn, $sql);

$exclude = ['Closed', 'Resolved', 'Confirm', 'Requisition'];
