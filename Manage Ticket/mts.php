...
<head>
    ...
    <title>Manage</title>
    <link rel="stylesheet" href="mts.css"/>
...
$sql = "SELECT Staff_No, Username from secretary where username = '$yes'";
...
WHERE ticket.Residence_ID = residence.Residence_ID AND ticket.Residence_ID IN (
    SELECT Residence_ID
    FROM residence
...
$exclude = ['Closed', 'Pending', 'Requisition'];
